  ...
  return (
    <HeroCard theme={theme}>
      ...
      <HeroCommandBar theme={theme}>
        ...
        <HeroBarRight>
          <HeroNavBtn theme={theme} as={Link} to="/history" title="History">
          ...
          <HeroNavBtn theme={theme} as={Link} to="/categories" title="Categories">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <HeroNavBtn theme={theme} as={Link} to="/companies" title="Companies">
